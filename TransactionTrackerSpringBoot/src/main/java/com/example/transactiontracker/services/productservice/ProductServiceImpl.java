...
public class ProductServiceImpl implements ProductService {
    ...
    public void creatInitialProducts() {
        createProduct("1234", "Water", getCategoryFromId("1"), 100, "bottle", "water.jpg", 10);
        createProduct("2345", "Coke", getCategoryFromId("1"), 200, "bottle", "coke.jpg", 20);
        createProduct("9999", "Nachos", getCategoryFromId("2"), 250, "box", "nachos.jpg", 30);
    }
